...
public class ProfileFragment extends Fragment{
    ...
    public void open(){
        ...
        alertDialogBuilder.setPositiveButton("Take picture",
        ...
        alertDialogBuilder.setNegativeButton("Choose a picture",new DialogInterface.OnClickListener() {
            @Override
    ...
    private void changePhoto(File photoFile) {
        ...
        user.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                if (photoFile == null || imageProfile.getDrawable() == null){
